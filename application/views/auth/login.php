...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?= site_url('assets/AdminLTE-2.4.3/'); ?>plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <small class="login-box-msg"><?php echo lang('login_subheading');?></small>
...
<!-- iCheck -->
<script src="<?= site_url('assets/AdminLTE-2.4.3/'); ?>plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
