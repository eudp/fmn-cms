  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Carrusel Museos</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <a class="pull-right" href="<?= site_url('admin/carrusel-museos/') . $carousel['type'] . '/' .  $carousel['element_id']; ?>">Volver</a>
            </div>
            <!-- /.box-header -->
			<?php echo form_open_multipart('admin/carrusel-museos'); ?>
			<div class="box-body">
