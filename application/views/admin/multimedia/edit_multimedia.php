<div class="container">
	<div class="row">
		...
		<div class="col-12">
			<?php echo form_open_multipart('admin/set_multimedia/'); ?>
			...
			<?php 
				...
				$documento = ($multimedia['type'] == 54 ? 'checked' : '');

			?>
			<div class="custom-control custom-radio">
				<input type="radio" id="customRadio1" name="tipo" class="custom-control-input" value="0" <?= $audio;?>>
